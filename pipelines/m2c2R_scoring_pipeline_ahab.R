...
fn_cogtask_colordots <- files_in_zip[grepl("Color-Dots_", files_in_zip)]
fn_cogtask_mot <- files_in_zip[grepl("Multiple-Object-Tracking_", files_in_zip)]
...
raw_cogtask_dotmemory <- read_cog_data(fn_cogtask_dotmemory) %>% select(-where(~all(is.na(.))))
raw_cogtask_symbolsearch <- read_cog_data(fn_cogtask_symbolsearch) %>% select(-where(~all(is.na(.))))
raw_cogtask_colordots <- read_cog_data(fn_cogtask_colordots) %>% select(-where(~all(is.na(.))))
raw_cogtask_mot <- read_cog_data(fn_cogtask_mot) %>% select(-where(~all(is.na(.))))
...
scored_cogtask_colordots <- score_task(raw_cogtask_colordots, m2c2R::score_color_dots)
scored_cogtask_mot <- score_task(raw_cogtask_mot, m2c2R::score_mot)
...
summary_cogtask_colordots_person <- summary_task(scored_cogtask_colordots, m2c2R::summary_color_dots, c("participant_id"))
summary_cogtask_mot_person <- summary_task(scored_cogtask_mot, m2c2R::summary_mot, c("participant_id"))
...
summary_cogtask_colordots_personsession <- summary_task(scored_cogtask_colordots, m2c2R::summary_color_dots, c("participant_id", "session_uuid"))
summary_cogtask_mot_personsession <- summary_task(scored_cogtask_mot, m2c2R::summary_mot, c("participant_id", "session_uuid"))
...
export_data(raw_cogtask_colordots, "output/")
export_data(raw_cogtask_mot, "output/")

# Export scored data
export_data(scored_cogtask_dotmemory, "output/")
export_data(scored_cogtask_symbolsearch, "output/")
export_data(scored_cogtask_colordots, "output/")
export_data(scored_cogtask_mot, "output/")


# Export summary data
export_data(summary_cogtask_dotmemory_person, "output/")
export_data(summary_cogtask_symbolsearch_person, "output/")
export_data(summary_cogtask_colordots_person, "output/")
export_data(summary_cogtask_mot_person, "output/")


export_data(summary_cogtask_dotmemory_personsession, "output/")
export_data(summary_cogtask_symbolsearch_personsession, "output/")
export_data(summary_cogtask_colordots_personsession, "output/")
export_data(summary_cogtask_mot_personsession, "output/")
